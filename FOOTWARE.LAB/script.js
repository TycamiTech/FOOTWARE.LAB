document.addEventListener('DOMContentLoaded', () => {
    ...
    const modalContactBtn = modal.querySelector('.btn-primary-yellow');
    ...
    detailButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            const message = `Halo FOOTWARE.LAB, saya ingin memesan layanan ${title}.`;
            modalContactBtn.href = `https://wa.me/6285126446219?text=${encodeURIComponent(message)}`;
